...
// Función directa y segura para acceder al panel de administración
function solicitarAdmin() {
    ...
    // Capturar datos del formulario (asegúrate de que los IDs coincidan con tu HTML)
...
// Nota: Asegúrate de que btnGps, gpsStatus e inputUbicacion estén declarados arriba con getElementById
if (typeof btnGps !== 'undefined' && btnGps) {
